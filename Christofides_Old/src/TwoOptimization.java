...
//    public List<Integer> alternate3Opt(List<Integer> cities) {
//        List<Integer> newTour;
//
//        int newDist;
//        int swaps = 1;
...
//                		comparisons++;
//
//                        if(distanceGraph[cities.get(i)][cities.get(i-1)] + distanceGraph[cities.get(j+1)][cities.get(j)] + distanceGraph[cities.get(k-1)][cities.get(k)] >= 
//                        		distanceGraph[cities.get(i)][cities.get(j)] + distanceGraph[cities.get(i-1)][cities.get(k)] + distanceGraph[cities.get(j+1)][cities.get(k-1)]) {
//
//                           newTour = swap(cities, i, k);
//                           newTour = swap(newTour, j, k);
//                           newDist = Christofides.calculateNewDistance(newTour);
//
//                            if (newDist < fitness) {
//                                cities = newTour;
...
//    public List<Integer> alternate2H(List<Integer> cities) {
//        List<Integer> newTour;
//
//        int newDist;
//        int swaps = 1;
...
//                    
//
//                    if(distanceGraph[cities.get(i-1)][cities.get(i)] + distanceGraph[cities.get(i)][cities.get(j)] + distanceGraph[cities.get(j+1)][cities.get(i+3)] 
//                    		>= distanceGraph[cities.get(i-1)][cities.get(j)] + distanceGraph[cities.get(j+1)][cities.get(i)] + distanceGraph[cities.get(i)][cities.get(i+3)]) {
//
//                       newTour = moveBetween(cities, i, j);
//                        newDist = Christofides.calculateNewDistance(newTour);
//
//                        if (newDist < fitness) {
//                            cities = newTour;
...
//    }
//    
//    private List<Integer> moveBetween(List<Integer> cities, int i, int j) {
//
